...
def main():
    ...
    while True:
        ...
        # Screen reflection #############################################################
        cv.imshow('Abecedario', debug_image)
...
def draw_landmarks(image, landmark_point):
    if len(landmark_point) > 0:
        ...
        middle_finger_dip = landmark_point[11]
        ...
        if abs(thumb_tip[1] - index_finger_pip[1]) < 45 \
            ...
            cv.putText(image, 'A', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
        # Detectar letra B
            ...
            cv.putText(image, 'B', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
        # Letra K
         ...
         cv.putText(image, 'K', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
         # Letra C
        elif abs(index_finger_tip[1] - thumb_tip[1]) < 360 and \
              index_finger_tip[1] - middle_finger_pip[1] < 0 and index_finger_tip[1] - middle_finger_tip[
                  1] < 0 and \
              index_finger_tip[1] - index_finger_pip[1] > 0:
         cv.putText(image, 'C', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
        ...
        # Letra D
            ...
            cv.putText(image, 'D', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
        # Letra E
            ...
            cv.putText(image, 'E', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
        # Letra F
            ...
            cv.putText(image, 'F', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)

        # Condición para detectar la letra "G"
            ...
            cv.putText(image, 'G', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
        # Letra H
            ...
            cv.putText(image, 'H', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
            # Letra I
                ...
                ring_finger_tip[1] > thumb_tip[1] > ring_finger_pip[1] and \
                 thumb_tip[0] < index_finger_mcp[0] + 15:
            cv.putText(image, 'I', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
        # Letra J
        elif abs(pinky_tip[1] - pinky_mcp[1]) > 30 and \
                 abs(index_finger_mcp[1] - middle_finger_mcp[1]) < 20 and \
                 abs(middle_finger_mcp[1] - ring_finger_mcp[1]) < 20 and \
                 index_finger_tip[1] > index_finger_mcp[1] and \
                ring_finger_tip[1] > thumb_tip[1] > ring_finger_pip[1] and \
                 abs(thumb_tip[0] - index_finger_mcp[
                     0]) > 20:  # Ajuste para que el pulgar esté alineado horizontalmente
            cv.putText(image, 'J', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
            # Letra L
        elif abs(index_finger_mcp[1] - index_finger_pip[1]) > 30 and \
             abs(index_finger_pip[1] - index_finger_dip[1]) > 30 and \
             abs(index_finger_dip[1] - index_finger_tip[1]) > 30 and \
             abs(thumb_cmc[0] - thumb_tip[0]) > 30 and \
             abs(thumb_mcp[0] - thumb_tip[0]) > 30 and \
             abs(thumb_tip[1] - index_finger_mcp[1]) < 40:  # Pulgar cerca del MCP del índice
                cv.putText(image, 'L', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
                # Letra M
                ...
                abs   (thumb_tip[1] < index_finger_pip[1] )- 20 and \
                abs   (thumb_tip[1] < middle_finger_pip[1]) - 20 and \
                abs   (thumb_tip[1] < ring_finger_pip[1]) - 20:  # El pulgar debe cubrir las puntas de los dedos índice, medio y anular con más flexibilidad
                     cv.putText(image, 'M', (500, 100), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255), 6)
                     # Letra N

            # Condición para detectar la letra "O"
